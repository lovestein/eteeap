...
?>
<!-- Hero -->
<section class="bg-img-cover py-5">
    <div class="container-lg py-2">
        <div class="row align-items-end mt-md-5">
            <div class="col-md-6 text-light text-sm-start text-center mt-md-5">
                <h1 class="fw-bold display-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, pariatur.</h1>
                <h4>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus, nemo?</h4>
                <div class="row mt-3">
                    <div class="col text-sm-start text-center">
                        <button type="button" class="btn btn-primary d-inline-block me-2">Apply Now</button>
...
<section class="bg-primary">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 py-5 px-4 text-sm-start text-center text-light">
            <h1 class="fw-bold">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem, esse!</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque delectus harum hic fugiat numquam necessitatibus soluta mollitia vitae itaque praesentium?</p>
        </div>
    </div>
</section>
